...
K_p_r_trial = np.arange(1, 3, 0.5)
K_p_v_trial = np.arange(1e6, 1.1e7, 3e6)
delta_v_trial = np.arange(1, 52, 15)
delta_r_trial = np.arange(0.001, 0.008, 0.001)
multi_m_r_trial = np.arange(1, 6, 1.5)
multi_p_r_trial = np.arange(1, 6, 1.5)
